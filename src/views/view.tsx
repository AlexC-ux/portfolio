...
function ReactComponent() {
    ...
    return (<>
        ...
        <div className="container bg-dark text-light mt-5">
            ...
            <Card theme="red" time={new Date("08 27 2022")} link="//github.com/AlexC-ux" linkText="Открыть GitHub" title="Портфолио" imageLink={`${publicPath}/images/products/activemkt.png` }
            ...
            <Card theme="red" time={new Date("08 19 2022")} tag1=<div>TSX + Node.Js</div> tag2=<a href="https://web.archive.org/web/20220827154459/https://xn--80aerhcl3be.xn--p1ai/"><i className="bi bi-box-arrow-up-right mx-2"></i>WebArchive</a> link="//активмкт.рф" linkText="Открыть сайт" title="Сайт студентческого актива МКТ" imageLink={`${publicPath}/images/products/activemkt.png`}
                text=<div>Сайт, разработанный как инициатива студенческого активма Московского колледжа транспорта.
                    <br />Стэк: <code>JS</code>, <code>React</code>, <code>Node.js</code>, <code>Typescript</code>, <code>HTML5</code>, <code>CSS</code>.
                    <br />С нуля разработанный backend и frontend, личный кабинет, квизы и конкурсы.</div>
            />
            ...
            <Card theme="green" time={new Date("04 25 2022")} tag1=<div>PHP + CMS Joomla</div> link="//github.com/AlexC-ux/EncryShare-Java" linkText="Открыть репозиторий" title="Мессенджер EncryShare" imageLink={`${publicPath}/images/products/encryshare.png`}
            ...
            <Card theme="blue" time={new Date("01 31 2022")} tag1=<div>PHP + CMS Joomla</div> tag2=<a href="//web.archive.org/web/20220322150522/http://mkgt.ru/"><i className="bi bi-box-arrow-up-right mx-2"></i>WebArchive</a> link="//mkgt.ru" linkText="Открыть сайт" title="Сайт Московского колледжа транспорта" imageLink={`${publicPath}/images/products/mkgt.png`}
                text=<div>Сайт, разработанный для образовательной организации "Московский колледж транспорта".
