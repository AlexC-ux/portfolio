...
function ReactComponent() {
    ...
    return (<>
        ...
        <div className="container bg-dark text-light mt-5">
            ...
            <Card theme="red" time={new Date()} tag1=<div>TSX + Node.Js</div> tag2=<a href="https://web.archive.org/web/20220827154459/https://xn--80aerhcl3be.xn--p1ai/"><i className="bi bi-box-arrow-up-right mx-2"></i>WebArchive</a> link="//активмкт.рф" linkText="Открыть сайт" title="Сайт студентческого актива МКТ" imageLink="/images/products/activemkt.png"
